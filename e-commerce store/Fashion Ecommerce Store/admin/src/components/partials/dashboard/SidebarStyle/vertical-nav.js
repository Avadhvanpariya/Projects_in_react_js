...
const VerticalNav = memo(() => {
  ...
  const menuItems = [
    ...
    {
      path: '/order', name: 'Order', icon: <AllInboxIcon />
    },
    {
      path: '/product', name: 'Products', icon: <SellIcon />
    },
    {
      path: '/analytics', name: 'analytics', icon: <AssessmentIcon />
    },
    {
      path: '/abandoned_checkouts', name: 'Abandoned Checkouts', icon: <RemoveShoppingCartIcon />
    },
    {
      path: '/inquiry/list', name: 'Inquiry List', icon: <DraftsIcon />
    },
    {
      path: '/video-book/list', name: 'Video Call Book List', icon: <VideoCameraFrontIcon />
    },
    // {
    //   path: '/paymentlist', name: 'Payments', icon: <CurrencyRupeeIcon />
    // },
    {
      path: '/auth/logout',
      name: 'Logout',
